...
MODEL_FILES = {
    'mobilenet_v2': os.path.join(args.models_dir, 'standard/mobilenetv2-12.onnx'),
    'mobilenet_v2_quant': os.path.join(args.models_dir, 'quantized/mobilenetv2-12-int8.onnx')
}
